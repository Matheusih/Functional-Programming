...
testeTop = abigStep(Som (Num 1) (Num 3), meuEstado)
...
testeTop2 = bbigStep(And FALSE TRUE, meuEstado)
...
cbigStep(For x e1 e2 c, s) = cbigStep( If (Leq e1 e2)  (Seq c (For x (Som e1 (Num 1)) e2 c))  (Skip), s )
